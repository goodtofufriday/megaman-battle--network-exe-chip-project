...
<part name="." library="atmel" library_urn="urn:adsk.eagle:library:105" deviceset="AT90*2343" device="S" package3d_urn="urn:adsk.eagle:package:4326/1" technology="S"/>
</parts>
<sheets>
<sheet>
<plain>
...
<instance part="." gate="G$1" x="43.18" y="40.64" smashed="yes">
<attribute name="VALUE" x="30.48" y="30.48" size="1.778" layer="96"/>
<attribute name="NAME" x="30.48" y="49.022" size="1.778" layer="95"/>
</instance>
</instances>
<busses>
</busses>
...
<segment>
<pinref part="." gate="G$1" pin="(MOSI)PB0"/>
...
<pinref part="." gate="G$1" pin="(SCK)PB2"/>
...
<pinref part="." gate="G$1" pin="(MISO)PB1"/>
